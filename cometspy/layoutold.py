...
class layout:
    ...
    chemotaxis : pandas.DataFrame
        info on chemotaxis coefficient and nutrient parameters for a specific model
        and media. see set_chemotaxis
    barriers : list(tuple)
    ...
    def set_chemotaxis(self, model: int, met : str, coeff: float, n_param: float):
        ...
        0 68 0.001
        //
        model_media_nutrient_params
        0 68 1.7e-5
        sets the chemotaxis coefficient for a metabolite across space
        
        This is the most common way to set the chemotaxis coefficient
        for a metabolite.
        ...
        >>> l = c.layout([model])
        >>> l.set_chemotaxis(0, "o2_e", 0.1, 1.7e-5)
